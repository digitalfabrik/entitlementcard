...
object GraphQLRequestSerializer {
    ...
    fun serializeObject(obj: Any): String =
        obj::class.declaredMemberProperties.filter { it.visibility == KVisibility.PUBLIC }
    ...
    private fun <R> readInstanceProperty(
        instance: Any,
        propertyName: String,
    ): R? {
        val property = instance::class.declaredMembers.first {
