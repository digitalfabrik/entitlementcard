...
import xyz.elitese.ehrenamtskarte.stores.webservice.schema.AcceptingStoreQueryService
import xyz.elitese.ehrenamtskarte.stores.webservice.schema.CategoriesQueryService
import java.io.IOException

class GraphQLHandler {
    companion object {
        private val config =
            SchemaGeneratorConfig(supportedPackages = listOf("xyz.elitese.ehrenamtskarte.stores.webservice.schema"))
