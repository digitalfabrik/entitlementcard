...
import app.ehrenamtskarte.backend.exception.webservice.exceptions.FreinetDataTransferNotActivatedException
    ...
    fun sendApplicationDataToFreinet(applicationId: Int, project: String, dfe: DataFetchingEnvironment): Boolean {
        ...
        return transaction {
            ...
            if (!freinetAgency.dataTransferActivated) {
                ...
                throw FreinetDataTransferNotActivatedException()
            }
