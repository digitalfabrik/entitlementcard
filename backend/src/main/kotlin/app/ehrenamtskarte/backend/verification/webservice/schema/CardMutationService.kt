...
class CardMutationService {
    ...
    private fun validateCodeType(card: CardGenerationModel): Boolean {
    ...
    private fun validateCardHash(cardHash: ByteArray): Boolean {
