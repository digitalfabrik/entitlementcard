...
val EAK_BAYERN_REGIONS = listOf(
    ...
    listOf("Landkreis", "Ansbach", "09571", "http://www.landkreis-ansbach.de/Leben-im-Landkreis/Ehrenamtskarte"),
    listOf(
        "Stadt",
        "Aschaffenburg",
        "09661",
    ...
    listOf("Landkreis", "Bad Tölz-Wolfratshausen", "09173", "http://www.engagementkompass.net/index.php?id=0,1258"),
    listOf("Stadt", "Bamberg", "09461", "http://www.stadt.bamberg.de/index.phtml?mNavID=1829.376&sNavID=1829.689&La=1"),
    listOf(
        "Landkreis",
        "Bamberg",
        "09471",
    ...
    listOf("Stadt", "Bayreuth", "09462", "http://www.bayreuth.de/rathaus-buergerservice/leben-in-bayreuth/ehrenamt/"),
    listOf("Landkreis", "Bayreuth", "09472", "https://www.landkreis-bayreuth.de/der-landkreis/ehrenamt/"),
    listOf(
        "Landkreis",
    ...
    listOf("Landkreis", "Cham", "09372", "https://www.landkreis-cham.de/service-beratung/ehrenamt/ehrenamtskarte/"),
    listOf("Stadt", "Coburg", "09463", "http://www.coburg.de/desktopdefault.aspx/tabid-2566/2661_read-13746/"),
    listOf(
        "Landkreis",
        "Coburg",
        "09473",
    ...
    listOf("Landkreis", "Dillingen a.d.Donau", "09773", "https://www.landkreis-dillingen.de/index.php?id=0,153"),
    listOf(
        "Landkreis",
        "Dingolfing-Landau",
        "09279",
    ...
    listOf("Landkreis", "Donau-Ries", "09779", "http://www.donauries.bayern/ehrenamt/ehrenamtskarte-bayern/"),
    ...
    listOf("Stadt", "Erlangen", "09562", "https://www.erlangen.de/desktopdefault.aspx/tabid-1166/3813_read-37404/"),
    listOf(
        "Landkreis",
        "Erlangen-Höchstadt",
        "09572",
    ...
    listOf("Landkreis", "Fürth", "09573", "http://www.landkreis-fuerth.de/daten-startseite/ehrenamtskarte.html"),
    ...
    listOf("Landkreis", "Günzburg", "09774", "http://www.fz-stellwerk.de/ehrenamtskarte/voraussetzungen-antrag/"),
    listOf("Landkreis", "Garmisch-Partenkirchen", "09180", "http://www.ehrenamtskarte-gap.de/"),
    listOf("Landkreis", "Haßberge", "09674", "http://www.ehrenamt-hassberge.de/anerkennung-fuer-das-ehrenamt"),
    listOf("Stadt", "Hof", "09464", "http://www.stadt-hof.de/hof/hof_deu/leben/ehrenamtskarte.html"),
    listOf("Landkreis", "Hof", "09475", "https://www.landkreis-hof.de/leben/ehrenamt/ehrenamtskarte/"),
    listOf("Stadt", "Ingolstadt", "09161", "http://www2.ingolstadt.de/Bürgerservice/Lebenslagen/Ehrenamtskarte/"),
    listOf("Stadt", "Kaufbeuren", "09762", "http://www.kaufbeuren-aktiv.de/aktiv-werden/bay.-ehrenamtskarte"),
    listOf("Landkreis", "Kelheim", "09273", "https://www.landkreis-kelheim.de/landkreis/ehrenamtskarte/"),
    listOf(
        "Landkreis",
        "Kitzingen",
        "09675",
    ...
    listOf("Stadt", "Nürnberg", "09564", "https://www.nuernberg.de/internet/nuernberg_engagiert/ehrenamtskarte.html"),
    listOf("Landkreis", "Nürnberger Land", "09574", "http://landkreis.nuernberger-land.de/index.php?id=3272"),
    listOf(
        "Landkreis",
    ...
    listOf("Landkreis", "Neumarkt i.d.OPf.", "09373", "http://landkreis-neumarkt.de/ehrenamtskarte"),
    listOf(
        "Landkreis",
    ...
    listOf("Landkreis", "Rhön-Grabfeld", "09673", "https://www.rhoen-grabfeld.de/Landkreis/Ehrenamt/Ehrenamtskarte"),
    listOf(
        "Stadt",
        "Rosenheim",
        "09163",
    ...
    listOf("Landkreis", "Rosenheim", "09187", "https://www.landkreis-rosenheim.de/ehrenamtskarten-ehrungen-orden/"),
    ...
    listOf("Stadt", "Straubing", "09263", "http://www.straubing.de/de/buerger-und-soziales/ehrenamt/"),
    listOf(
        "Landkreis",
        "Straubing-Bogen",
        "09278",
    ...
    listOf("Landkreis", "Traunstein", "09189", "https://www.traunstein.com/buerger-verwaltung/freiwilligenagentur"),
    ...
    listOf("Landkreis", "Weißenburg-Gunzenhausen", "09577", "http://www.altmuehlfranken.de/ehrenamtskarte"),
    listOf("Stadt", "Weiden i.d.OPf.", "09363", "https://www.weiden.de/kultur/ehrenamt/ehrenamtskarte"),
    listOf(
        "Landkreis",
        "Weilheim-Schongau",
        "09190",
    ...
    listOf("Landkreis", "Wunsiedel i.Fichtelgebirge", "09479", "http://www.landkreis-wunsiedel.de/ehrenamtskarte")
)
