...
class BuildConfigBuilder extends Builder {
  ...
  FutureOr<void> build(BuildStep buildStep) async {
    ...
    if (exitCode != 0) {
      throw "Failed to execute app-toolbelt. Exit code $exitCode: ${process.stderr.toString()}";
    }

    final Map<String, dynamic> json = jsonDecode(process.stdout.toString()) as Map<String, dynamic>;
    final dataModel = StringBuffer()
      ..write("// Autogenerated. Do not modify!\n\n")
      ..write('const String buildConfigName = "${escape(name)}";\n\n');
