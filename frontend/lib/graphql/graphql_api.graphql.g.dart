...
GetRegionsById$Query _$GetRegionsById$QueryFromJson(Map<String, dynamic> json) {
  return GetRegionsById$Query()
    ..regionsById = (json['regionsById'] as List<dynamic>)
        .map((e) => GetRegionsById$Query$Region.fromJson(e as Map<String, dynamic>))
        .toList();
}
...
Map<String, dynamic> _$IdsParamsInputToJson(IdsParamsInput instance) => <String, dynamic>{
      'ids': instance.ids,
    };

GetRegions$Query$Region _$GetRegions$Query$RegionFromJson(Map<String, dynamic> json) {
...
AcceptingStoresSearch$Query$AcceptingStore$PhysicalStore$Address
  ...
  return AcceptingStoresSearch$Query$AcceptingStore$PhysicalStore$Address()..location = json['location'] as String?;
}
...
Map<String, dynamic> _$AcceptingStoresSearch$QueryToJson(AcceptingStoresSearch$Query instance) => <String, dynamic>{
      'searchAcceptingStores': instance.searchAcceptingStores.map((e) => e.toJson()).toList(),
    };
...
AcceptingStoreById$Query$PhysicalStore$AcceptingStore _$AcceptingStoreById$Query$PhysicalStore$AcceptingStoreFromJson(
  ...
  return AcceptingStoreById$Query$PhysicalStore$AcceptingStore()
    ...
    ..description = json['description'] as String?
    ..contact =
        AcceptingStoreById$Query$PhysicalStore$AcceptingStore$Contact.fromJson(json['contact'] as Map<String, dynamic>)
...
AcceptingStoreById$Query _$AcceptingStoreById$QueryFromJson(Map<String, dynamic> json) {
  return AcceptingStoreById$Query()
    ..physicalStoresById = (json['physicalStoresById'] as List<dynamic>)
        .map((e) => AcceptingStoreById$Query$PhysicalStore.fromJson(e as Map<String, dynamic>))
        .toList();
}

Map<String, dynamic> _$AcceptingStoreById$QueryToJson(AcceptingStoreById$Query instance) => <String, dynamic>{
      'physicalStoresById': instance.physicalStoresById.map((e) => e.toJson()).toList(),
    };
...
AcceptingStoreSummaryById$Query _$AcceptingStoreSummaryById$QueryFromJson(Map<String, dynamic> json) {
  return AcceptingStoreSummaryById$Query()
    ..physicalStoresById = (json['physicalStoresById'] as List<dynamic>)
        .map((e) => AcceptingStoreSummaryById$Query$PhysicalStore.fromJson(e as Map<String, dynamic>))
        .toList();
}
...
AddBlueEakApplication$Mutation _$AddBlueEakApplication$MutationFromJson(Map<String, dynamic> json) {
  return AddBlueEakApplication$Mutation()..addBlueEakApplication = json['addBlueEakApplication'] as bool;
}

Map<String, dynamic> _$AddBlueEakApplication$MutationToJson(AddBlueEakApplication$Mutation instance) =>
    <String, dynamic>{
      'addBlueEakApplication': instance.addBlueEakApplication,
    };

BlueCardApplicationInput _$BlueCardApplicationInputFromJson(Map<String, dynamic> json) {
  return BlueCardApplicationInput(
    applicationType:
        _$enumDecode(_$ApplicationTypeEnumMap, json['applicationType'], unknownValue: ApplicationType.artemisUnknown),
    entitlement: BlueCardEntitlementInput.fromJson(json['entitlement'] as Map<String, dynamic>),
    givenInformationIsCorrectAndComplete: json['givenInformationIsCorrectAndComplete'] as bool,
    hasAcceptedPrivacyPolicy: json['hasAcceptedPrivacyPolicy'] as bool,
    personalData: PersonalDataInput.fromJson(json['personalData'] as Map<String, dynamic>),
  );
}

Map<String, dynamic> _$BlueCardApplicationInputToJson(BlueCardApplicationInput instance) => <String, dynamic>{
      'applicationType': _$ApplicationTypeEnumMap[instance.applicationType],
      'entitlement': instance.entitlement.toJson(),
      'givenInformationIsCorrectAndComplete': instance.givenInformationIsCorrectAndComplete,
...
BlueCardEntitlementInput _$BlueCardEntitlementInputFromJson(Map<String, dynamic> json) {
  return BlueCardEntitlementInput(
    copyOfJuleica:
        json['copyOfJuleica'] == null ? null : AttachmentInput.fromJson(json['copyOfJuleica'] as Map<String, dynamic>),
    entitlementType: _$enumDecode(_$BlueCardEntitlementTypeEnumMap, json['entitlementType'],
    ...
    serviceEntitlement: json['serviceEntitlement'] == null
        ? null
        : BlueCardServiceEntitlementInput.fromJson(json['serviceEntitlement'] as Map<String, dynamic>),
    workAtOrganizations: (json['workAtOrganizations'] as List<dynamic>?)
        ?.map((e) => WorkAtOrganizationInput.fromJson(e as Map<String, dynamic>))
        .toList(),
  );
}

Map<String, dynamic> _$BlueCardEntitlementInputToJson(BlueCardEntitlementInput instance) => <String, dynamic>{
      'copyOfJuleica': instance.copyOfJuleica?.toJson(),
      'entitlementType': _$BlueCardEntitlementTypeEnumMap[instance.entitlementType],
      ...
      'workAtOrganizations': instance.workAtOrganizations?.map((e) => e.toJson()).toList(),
    };
...
Map<String, dynamic> _$AttachmentInputToJson(AttachmentInput instance) => <String, dynamic>{
      'data': fromDartMultipartFileToGraphQLUpload(instance.data),
      'fileName': instance.fileName,
    };

BlueCardServiceEntitlementInput _$BlueCardServiceEntitlementInputFromJson(Map<String, dynamic> json) {
  return BlueCardServiceEntitlementInput(
    certificate:
        json['certificate'] == null ? null : AttachmentInput.fromJson(json['certificate'] as Map<String, dynamic>),
    organization: OrganizationInput.fromJson(json['organization'] as Map<String, dynamic>),
    responsibility: json['responsibility'] as String?,
  );
}

Map<String, dynamic> _$BlueCardServiceEntitlementInputToJson(BlueCardServiceEntitlementInput instance) =>
    <String, dynamic>{
...
OrganizationInput _$OrganizationInputFromJson(Map<String, dynamic> json) {
  return OrganizationInput(
    ...
    contact: OrganizationContactInput.fromJson(json['contact'] as Map<String, dynamic>),
    name: json['name'] as String,
    website: json['website'] as String?,
  );
}

Map<String, dynamic> _$OrganizationInputToJson(OrganizationInput instance) => <String, dynamic>{
      'address': instance.address.toJson(),
...
Map<String, dynamic> _$AddressInputToJson(AddressInput instance) => <String, dynamic>{
...
OrganizationContactInput _$OrganizationContactInputFromJson(Map<String, dynamic> json) {
...
Map<String, dynamic> _$OrganizationContactInputToJson(OrganizationContactInput instance) => <String, dynamic>{
      'email': instance.email,
...
WorkAtOrganizationInput _$WorkAtOrganizationInputFromJson(Map<String, dynamic> json) {
  return WorkAtOrganizationInput(
    amountOfWork: (json['amountOfWork'] as num).toDouble(),
    amountOfWorkUnit: _$enumDecode(_$AmountOfWorkUnitEnumMap, json['amountOfWorkUnit'],
...
Map<String, dynamic> _$WorkAtOrganizationInputToJson(WorkAtOrganizationInput instance) => <String, dynamic>{
...
Map<String, dynamic> _$PersonalDataInputToJson(PersonalDataInput instance) => <String, dynamic>{
      'address': instance.address.toJson(),
...
AddGoldenEakApplication$Mutation _$AddGoldenEakApplication$MutationFromJson(Map<String, dynamic> json) {
  return AddGoldenEakApplication$Mutation()..addGoldenEakApplication = json['addGoldenEakApplication'] as bool;
}

Map<String, dynamic> _$AddGoldenEakApplication$MutationToJson(AddGoldenEakApplication$Mutation instance) =>
    <String, dynamic>{
      'addGoldenEakApplication': instance.addGoldenEakApplication,
    };

GoldenEakCardApplicationInput _$GoldenEakCardApplicationInputFromJson(Map<String, dynamic> json) {
  return GoldenEakCardApplicationInput(
    entitlement: GoldenCardEntitlementInput.fromJson(json['entitlement'] as Map<String, dynamic>),
    givenInformationIsCorrectAndComplete: json['givenInformationIsCorrectAndComplete'] as bool,
    hasAcceptedPrivacyPolicy: json['hasAcceptedPrivacyPolicy'] as bool,
    personalData: PersonalDataInput.fromJson(json['personalData'] as Map<String, dynamic>),
  );
...
Map<String, dynamic> _$GoldenEakCardApplicationInputToJson(GoldenEakCardApplicationInput instance) => <String, dynamic>{
      'entitlement': instance.entitlement.toJson(),
      'givenInformationIsCorrectAndComplete': instance.givenInformationIsCorrectAndComplete,
      'hasAcceptedPrivacyPolicy': instance.hasAcceptedPrivacyPolicy,
      'personalData': instance.personalData.toJson(),
...
GoldenCardEntitlementInput _$GoldenCardEntitlementInputFromJson(Map<String, dynamic> json) {
  return GoldenCardEntitlementInput(
    certificate:
        json['certificate'] == null ? null : AttachmentInput.fromJson(json['certificate'] as Map<String, dynamic>),
    goldenEntitlementType: _$enumDecode(_$GoldenCardEntitlementTypeEnumMap, json['goldenEntitlementType'],
...
Map<String, dynamic> _$GoldenCardEntitlementInputToJson(GoldenCardEntitlementInput instance) => <String, dynamic>{
      'certificate': instance.certificate?.toJson(),
      'goldenEntitlementType': _$GoldenCardEntitlementTypeEnumMap[instance.goldenEntitlementType],
      'workAtOrganizations': instance.workAtOrganizations?.map((e) => e.toJson()).toList(),
    };

const _$GoldenCardEntitlementTypeEnumMap = {
  GoldenCardEntitlementType.honorByMinisterPresident: 'HONOR_BY_MINISTER_PRESIDENT',
...
GetRegionsByIdArguments _$GetRegionsByIdArgumentsFromJson(Map<String, dynamic> json) {
...
AddBlueEakApplicationArguments _$AddBlueEakApplicationArgumentsFromJson(Map<String, dynamic> json) {
  return AddBlueEakApplicationArguments(
    application: BlueCardApplicationInput.fromJson(json['application'] as Map<String, dynamic>),
    regionId: json['regionId'] as int,
  );
}

Map<String, dynamic> _$AddBlueEakApplicationArgumentsToJson(AddBlueEakApplicationArguments instance) =>
    <String, dynamic>{
      'application': instance.application.toJson(),
      'regionId': instance.regionId,
    };

AddGoldenEakApplicationArguments _$AddGoldenEakApplicationArgumentsFromJson(Map<String, dynamic> json) {
  return AddGoldenEakApplicationArguments(
    application: GoldenEakCardApplicationInput.fromJson(json['application'] as Map<String, dynamic>),
    regionId: json['regionId'] as int,
  );
}

Map<String, dynamic> _$AddGoldenEakApplicationArgumentsToJson(AddGoldenEakApplicationArguments instance) =>
    <String, dynamic>{
      'application': instance.application.toJson(),
      'regionId': instance.regionId,
    };
