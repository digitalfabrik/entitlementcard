...
class CardVerifyModel_CardType extends $pb.ProtobufEnum {
  static const CardVerifyModel_CardType STANDARD = CardVerifyModel_CardType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'STANDARD');
  static const CardVerifyModel_CardType GOLD = CardVerifyModel_CardType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'GOLD');
