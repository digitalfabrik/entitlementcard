...
class CardActivateModel_CardType extends $pb.ProtobufEnum {
  static const CardActivateModel_CardType STANDARD =
      CardActivateModel_CardType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'STANDARD');
  static const CardActivateModel_CardType GOLD =
      CardActivateModel_CardType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'GOLD');
