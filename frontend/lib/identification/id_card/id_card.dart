...
class IdCard extends StatelessWidget {
  ...
  const IdCard(
      {super.key, required this.cardInfo, required this.region, required this.isExpired, required this.isStillInvalid});
      ...
      child: ConstrainedBox(
        ...
        child: AspectRatio(
          ...
          child: MediaQuery(
            ...
            child:
                CardContent(cardInfo: cardInfo, region: region, isExpired: isExpired, isStillInvalid: isStillInvalid),
          ),
        ),
      ),
    );
