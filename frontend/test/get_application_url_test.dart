...
void main() {
  group('getApplicationUrlForCardExtension', () {
    test('results in url with queryParams for koblenz', () {
      ...
      final applicationUrlWithParameters = getApplicationUrlForCardExtension(
        applicationUrl,
        cardInfo,
        applicationUrlQueryKeyName,
        applicationUrlQueryKeyBirthday,
        applicationUrlQueryKeyReferenceNumber,
      );
      expect(
