...
Import of EAK accepting stores on prod and staging envs run on **every odd day** of the month.
...
```
root@entitlementcard-test ~ # su - backend
backend@entitlementcard-test:~$ /opt/ehrenamtskarte/backend/bin/backend import
```
