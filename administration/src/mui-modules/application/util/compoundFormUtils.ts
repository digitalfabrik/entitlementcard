...
const mapValues = <VPre extends { [k in keyof VPre]: unknown }, VPost extends { [k in keyof VPre]: unknown }>(
...
export const createCompoundInitialState = <Forms extends SubForms>(subForms: Forms): CompoundState<Forms> =>
