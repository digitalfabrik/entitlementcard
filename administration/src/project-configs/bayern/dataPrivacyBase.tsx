  ...
  <div>
    ...
    <p style={{ marginTop: '5pt', marginBottom: '5pt' }}>
      ...
      <a
        ...
        <span style={{ color: '#0000ff' }}>
          <u>Datenschutz@stmas.bayern.de</u>
        </span>
      </a>
      <span>
        <br />
    ...
    <p style={{ marginTop: '0pt', marginBottom: '0pt' }}>
      ...
      <a
        ...
        <span style={{ color: '#0000ff' }}>
          <u>https://www.datenschutz-bayern.de</u>
        </span>
      </a>
      ).{' '}
    </p>
    ...
    <p style={{ marginTop: '5pt', marginBottom: '5pt' }}>
      ...
      <span style={{ fontFamily: '"Calibri"', fontSize: '11pt' }}>&nbsp;</span>UAbs. 1 Buchstabe a DSGVO.
    </p>
    <p style={{ marginTop: '5pt', marginBottom: '5pt' }}>
      <span>
      ...
      <a
        ...
        <span style={{ color: '#0000ff' }}>
          <u>https://bayern.ehrenamtskarte.app/beantragen</u>
        </span>
      </a>
    ...
    <p style={{ marginTop: '5pt', marginBottom: '5pt' }}>
      ...
      unter 16 Jahren werden nicht bewusst erhoben und verarbeitet., da die digitale bayerische Ehrenamtskarte erst ab
      16 Jahren beantragt werden kann.
    </p>
    <p style={{ marginTop: '5pt', marginBottom: '5pt' }}>
      <span>
    ...
    <p style={{ marginTop: '5pt', marginBottom: '5pt' }}>
      ...
      , um Ihre Daten vor dem Zugriff Unberechtigter und vor Manipulation, Übermittlung, Verlust oder Zerstörung zu
      schützen. Unsere Sicherheitsverfahren überprüfen wir regelmäßig und passen sie dem technologischen Fortschritt an.
    </p>
    <p style={{ marginTop: '5pt', marginBottom: '5pt' }}>
      <span>
