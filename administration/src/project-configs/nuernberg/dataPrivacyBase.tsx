...
export const DataPrivacyBaseText = () => (
    <div>
        ...
        <p style={{marginTop: '5pt', marginBottom: '5pt'}}>
            Der digitale NürnbergPass wird im Auftrag der Stadt Nürnberg, Amt für Existenzsicherung und soziale
            Integration,
        ...
        <p style={{marginTop: '5pt', marginBottom: '5pt'}}>
            Der gesamte Programmcode des digitalen NürnbergPass ist darüber hinaus quelloffen lizenziert unter der
            MIT-Lizenz
        ...
        <span style={{color: '#0000ff'}}>
          <u>https://github.com/digitalfabrik/entitlementcard</u>
        </span>
            </a>
        </p>
        <p style={{marginTop: '5pt', marginBottom: '5pt'}}>
            Für nähere Informationen zur Verarbeitung Ihrer personenbezogenen Daten können Sie uns unter den unten
            genannten
      ...
      <span>
        ...
        Telefon:{' '}
            ...
            <br/>
            E-Mail:
            <a target='_blank' rel='noreferrer' href='mailto:SHA@stadt.nuernberg.de'
               title='mailto:SHA@stadt.nuernberg.de'>
        <span style={{color: '#0000ff'}}>
      ...
      <span>
        ...
        <p style={{marginTop: '5pt', marginBottom: '5pt'}}>
            Die Rechtsgrundlage für die Verarbeitung Ihrer Daten ergibt sich, soweit nichts anderes angegeben ist, aus
            Art. 4
            Abs. 1 des Bayerischen Datenschutzgesetzes (BayDSG) in Verbindung mit Art. 6 Abs. 1 UAbs. 1 Buchst. e der
            Datenschutzgrundverordnung (DSGVO). Demnach ist es uns erlaubt, die zur Erfüllung einer uns obliegenden
            Aufgabe
      ...
      <span>
        ...
        <b>
          <br/>
            ...
            Bei Nutzung der digitalen NürnbergPass-App (Android/iOS) werden folgende Nutzungsdaten gemäß § 15 Abs. 1 TMG
            bei
        ...
        <p style={{marginTop: '0pt', marginBottom: '0pt'}}>
            Sonstige Daten werden bei Ihrer Nutzung nicht automatisch erhoben und nicht an unsere Server gesendet. Nach
            dem
            Grundsatz der Datenvermeidung und der Datensparsamkeit sowie dem Grundsatz der anonymen und pseudonymen
            Nutzung
            ...
            mit
            Hilfe von Zusatzwissen auf eine bestimmte Person zurückgeführt werden. Die einzelnen Nutzerinnen und Nutzer
            können
            somit nicht identifiziert werden. Wir erstellen keine Nutzungsprofile.
        </p>
        <p style={{marginTop: '0pt', marginBottom: '0pt'}}>&nbsp;</p>
        <p style={{marginTop: '0pt', marginBottom: '0pt'}}>
            Zur Gewährleistung des technischen Betriebs wird die IP-Adresse für 14 Tage in den Serverprotokollen
            gespeichert
            und danach gelöscht.
        </p>
        <p style={{marginTop: '5pt', marginBottom: '5pt'}}>
        ...
        <p style={{marginTop: '5pt', marginBottom: '5pt'}}>
            ...
            Daten
            an das Landesamt für Sicherheit in der Informationstechnik weitergeleitet werden und dort auf Grundlage der
            Art.
            12 ff. des Bayerischen E-Government-Gesetzes verarbeitet werden. Ihre Daten werden an die&nbsp;Stadt
            Nürnberg, Amt
            für Existenzsicherung und soziale Integration, Dietzstraße 4, 90443 Nürnberg weitergegeben, um den
            NürnbergPass
      ...
      <span>
        ...
        <b>
          <br/>
            ...
            Außerhalb gesetzlicher Verpflichtungen dürfen personenbezogene Daten nur mit (und im Rahmen) Ihrer
            Zustimmung
            erhoben, genutzt oder verarbeitet werden.
        </p>
        <p style={{marginTop: '5pt', marginBottom: '5pt'}}>
            Beim Zugriff auf dieses Internetangebot werden von uns Cookies (kleine Dateien) auf Ihrer Festplatte mit
            einer
            Gültigkeitsdauer von zwölf Monaten gespeichert. Wir verwenden diese ausschließlich dazu, Sie bei diesem und
            weiteren Besuchen unserer Webseite wiedererkennen zu können. Die meisten Browser sind so eingestellt, dass
            sie die
            Verwendung von Cookies akzeptieren, diese Funktion kann aber durch die Einstellung des Internetbrowsers von
            Ihnen
        ...
        <p style={{marginTop: '5pt', marginBottom: '5pt'}}>
            ...
            digitalfabrik@tuerantuer.de widerrufen werden. In diesem Fall werden alle gespeicherten personenbezogenen
            Daten
            gelöscht. Aus der Nicht-Einwilligung oder einem Widerruf darf Ihnen kein Nachteil entstehen. Ein Widerruf
            kann nur
        ...
        <b>Einwilligung durch Minderjährige</b>
            ...
            <br/>
            Jugendliche können laut Art. 8 Abs. 1 DSGVO erst ab 16 Jahren wirksam in die Verarbeitung ihrer
            personenbezogenen
            Daten durch Dienstanbieter der Informationsgesellschaft einwilligen. Bei Minderjährigen unter 16 Jahren
            müssen die
      ...
      <span>
        ...
        <ul>
            ...
            <li>
                <p style={{marginTop: '5pt', marginBottom: '5pt'}}>
                    Wenn Sie in die Verarbeitung eingewilligt haben oder ein Vertrag zur Datenverarbeitung besteht und
                    die
                    Datenverarbeitung mithilfe automatisierter Verfahren durchgeführt wird, steht Ihnen gegebenenfalls
                    ein Recht
            ...
            <li>
                <p style={{marginTop: '5pt', marginBottom: '5pt'}}>
                    ...
                    beruht, können
                    Sie die Einwilligung jederzeit für die Zukunft widerrufen. Die Rechtmäßigkeit der aufgrund der
                    Einwilligung
            ...
            <li>
                <p style={{marginTop: '5pt', marginBottom: '5pt'}}>
                    ...
                    die
                    Verarbeitung Ihrer Daten Widerspruch einzulegen, wenn die Verarbeitung ausschließlich auf Grundlage
                    des Art. 6
      ...
      <span>
        ...
        Wir verwenden technische
            ...
            und organisatorische Maßnahmen, um Ihre Daten vor dem Zugriff Unberechtigter und vor Manipulation,
            Übermittlung,
            Verlust oder Zerstörung zu schützen. Unsere Sicherheitsverfahren überprüfen wir regelmäßig und passen sie
            dem
      ...
      <span>
        ...
        <b>
          <br/>
            ...
            Wenn Sie innerhalb unserer Online-Dienste aufgefordert werden personenbezogene Daten einzugeben, erfolgt
            deren
            Transport über das Internet unter Verwendung von SSL-Verschlüsselung, um Ihre Daten vor einer Kenntnisnahme
            durch
