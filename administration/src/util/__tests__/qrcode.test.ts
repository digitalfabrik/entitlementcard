...
import { CardInfo, DynamicActivationCode } from '../../generated/card_pb'
import bayernConfig from '../../project-configs/bayern/config'
import { convertProtobufToHexCode } from '../qrcode'
...
describe('qrcode', () => {
  describe('protobuf to hex converter', () => {
    it('should return hex', () => {
      ...
      const hex = convertProtobufToHexCode(protobufQRCode)
      expect(hex).toEqual(
