...
import uint8ArrayToPaddedBase64 from '../util/uint8ArrayToPaddedBase64'
...
export async function activateCard<T extends DynamicActivationCode | StaticVerificationCode>(
  ...
  const totpSecret =
    activationCode instanceof DynamicActivationCode ? uint8ArrayToPaddedBase64(activationCode.totpSecret) : null
  const card: CardGenerationModelInput = {
    ...
    cardInfoHashBase64: uint8ArrayToPaddedBase64(cardInfoHash),
