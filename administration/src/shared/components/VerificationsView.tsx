...
import { ApplicationPublic, ApplicationVerificationView } from '../../generated/graphql'
          ...
          return (
            <VerificationListItem
              ...
              showResendApprovalEmailButton={
                isAdminView === true && verificationStatus(verification) === VerificationStatus.Pending
              }
            />
          )
        })}
